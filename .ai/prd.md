...
- Kryteria akceptacji:
  ...
  3. Po wklejeniu tekstu i kliknięciu przycisku "Generate", system wysyła zapytanie do AI, a interfejs wyświetla wskaźnik ładowania.
...
- Kryteria akceptacji:
  ...
  2. W modalu edycji znajduje się przycisk "Reject", który zamyka modal i usuwa kandydata z listy.
...
- Kryteria akceptacji:
  ...
  2. W modalu znajdują się przyciski "Save and accept", "Reject" i "Cancel".
...
- Kryteria akceptacji:
  1. Kliknięcie przycisku "Accept all" powoduje zapisanie wszystkich widocznych na liście kandydatów do bazy danych.
...
- Kryteria akceptacji:
  1. Istnieje dedykowany widok "My cards".
...
- Kryteria akceptacji:
  1. Kliknięcie "Edit" przy fiszce otwiera formularz z jej aktualną treścią.
...
- Kryteria akceptacji:
  1. Kliknięcie "Delete" przy fiszce wyświetla prośbę o potwierdzenie.
...
- Kryteria akceptacji:
  ...
  2. Dostępny jest przycisk "Show answer", który odsłania tył fiszki.
  3. Pod odpowiedzią pojawiają się 2 przyciski oceny: "Don't know", "Know".
...
- Kryteria akceptacji:
  ...
  2. Użytkownikowi wyświetlany jest przyjazny komunikat, np. "An error occurred while generating flashcards. Please try again later."
